  ...
  return (
    <AnimatedSection>
      ...
      >
        ...
        {/* Mobile Overlay: Improves text readability on small screens by washing out the busy background */}
        <div className="absolute inset-0 z-0 bg-white/40 backdrop-blur-[1px] md:hidden" />
